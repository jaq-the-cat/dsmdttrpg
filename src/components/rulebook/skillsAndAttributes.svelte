<details>
  ...
  <p>
    Attributes go from 0 to 10, and give +1 to the relevant Dice roll per level,
    starting at -4. (10 gives +6)
  </p>
  <ul>
    <li>Vitality</li>
    <li>Agility</li>
...
<details>
  ...
  <p>
    Skills have the same roll bonus as the parent Stat (from -4 to +6), but can
