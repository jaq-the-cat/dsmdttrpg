...
export const weapons = {
    'Melee': {
        ...
        "Sword": new MeleeWeapon("Sword", 1, Rarity.Rare, "1d6 + Strength + 1 Slash", "-1 Hit, -1 Block"),
    ...
    'Special': {
        'Knife Tail': new MeleeWeapon("Knife Tail", 0, Rarity.VeryRare, "1d6 + Strength + 1 Slash", "+1 Successful Hits on hit"),
    },
    'Disassembly': {
        "Sword": new MeleeWeapon("Sword", 0, Rarity.Rare, "1d6 + Strength + 1 Slash", "-1 Hit, -1 Block"),
        "Claws": new MeleeWeapon("Claws", 0, Rarity.Rare, "1d8 + Strength + 2 Slash", "Rate up to 2"),
        "Chainsaw": new MeleeWeapon("Chainsaw", null, Rarity.VeryRare, "1d12 + Strength + 1 Slash", "+1 Hit, uses 1L Used Oil per Hit"),
        "SMG": RangedWeapon.loaded("Submachine Gun", 2, Rarity.SuperRare, "Firearms", "2 Pierce", 10, 6, 30, 1, null),
        "Laser": RangedWeapon.loaded("Laser", null, Rarity.Waow, "Firearms", "8 Energy", 20, 1, 2, 1, null),
        "Missile": new RangedWeapon("Missile", null, Rarity.Waow, "Firearms", "12 Explosive", 20, 1, "Tracking"),
        "Ninja Star": new Throwable("Ninja Star", null, Rarity.Waow, "4 Pierce", "10"),
    ...
    'Avian': {
        ...
        'Small Claws': new MeleeWeapon("Small Claws", 0, 0, "1d6 + Strength + 1 Slash", null),
        'Talon Dive': new MeleeWeapon("Talon Dive", 0, 0, "1d6 + Strength + 2 Slash", "Must be initiated from flight. When used, move a maximum of 20 meters horizontally in the direction of the target."),
        'Talon Strike': new MeleeWeapon("Talon Dive", 0, 0, "1d6 + Strength + 1 Slash", null),
    },
    'Solver': {
        ...
        'Solver Tail': new MeleeWeapon("Solver Tail", 0, Rarity.VeryRare, "1d6 + Strength Slash", "+1 Successful Hits on hit. May be used as an extra limb, flashlight or weapon. Lights up to 10m in front of the user in a cone. Range is 2m."),
        'Solver Claws': new MeleeWeapon("Solver Claws", 0, Rarity.VeryRare, "1d8 + Strength + 2 Slash", "Rate up to 2. If Both hands are claws, disable Solver Powers."),
        'Solver Stabbies': new MeleeWeapon("Solver Stabbies", 0, Rarity.VeryRare, "1d8 + Strength + 2 Pierce", "Rate 2. +1 Successful Hits on hit."),
    }
}